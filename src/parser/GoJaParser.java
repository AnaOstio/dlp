...
public class GoJaParser extends Parser {
	...
	public static final int
		...
		IDENTIFICADOR=44, COMMENT=45, MULTI_COMMENT=46, WS=47;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CHAR_CONSTANT", "IDENTIFICADOR", "COMMENT", "MULTI_COMMENT", "WS"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 28518586088456L) != 0)) {
				{
				{
				setState(49);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public StatementContext ini;
		public ExpresionContext e;
		public StatementContext inc;
		public StatementsContext cuerpo;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				match(T__2);
				setState(153);
				((StatementContext)_localctx).ini = statement();
				setState(154);
				((StatementContext)_localctx).e = expresion(0);
				setState(155);
				match(T__7);
				setState(156);
				((StatementContext)_localctx).inc = statement();
				setState(157);
				match(T__3);
				setState(158);
				((StatementContext)_localctx).cuerpo = statements();
				 ((StatementContext)_localctx).ast =  new For(((StatementContext)_localctx).l.getLine(), ((StatementContext)_localctx).l.getCharPositionInLine() + 1, ((StatementContext)_localctx).ini.ast, ((StatementContext)_localctx).e.ast, ((StatementContext)_localctx).inc.ast, ((StatementContext)_localctx).cuerpo.ast); 
				}
				break;
			case 8:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 28518585991176L) != 0)) {
					{
					setState(163);
					((StatementContext)_localctx).expresiones = expresiones();
	...
	public final TipoContext tipo() throws RecognitionException {
		...
		try {
			...
			case T__34:
				...
				{
				setState(297);
				((TipoContext)_localctx).a = match(T__34);
				setState(298);
				match(T__4);
				setState(304);
				_errHandler.sync(this);
