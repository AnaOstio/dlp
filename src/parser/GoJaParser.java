...
public class GoJaParser extends Parser {
	...
	public static final int
		...
		INT_CONSTANT=39, REAL_CONSTANT=40, REAL_1=41, REAL_2=42, CHAR_CONSTANT=43, 
		BOOLEAN=44, IDENTIFICADOR=45, COMMENT=46, MULTI_COMMENT=47, WS=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "INT_CONSTANT", "REAL_CONSTANT", "REAL_1", "REAL_2", 
			"CHAR_CONSTANT", "BOOLEAN", "IDENTIFICADOR", "COMMENT", "MULTI_COMMENT", 
			"WS"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 63737316277256L) != 0)) {
				{
				{
				setState(49);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 63737316245512L) != 0)) {
					{
					setState(153);
					((StatementContext)_localctx).expresiones = expresiones();
	...
	public static class ExpresionContext extends ParserRuleContext {
		...
		public TerminalNode BOOLEAN() { return getToken(GoJaParser.BOOLEAN, 0); }
	...
	private ExpresionContext expresion(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				setState(191);
				((ExpresionContext)_localctx).expresion = expresion(12);
			...
			case 10:
				{
				setState(215);
				((ExpresionContext)_localctx).BOOLEAN = match(BOOLEAN);
				 ((ExpresionContext)_localctx).ast =  new BooleanLiteral(((ExpresionContext)_localctx).BOOLEAN.getLine(), ((ExpresionContext)_localctx).BOOLEAN.getCharPositionInLine() + 1, LexerHelper.lexemeToBoolean((((ExpresionContext)_localctx).BOOLEAN!=null?((ExpresionContext)_localctx).BOOLEAN.getText():null))); 
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(221);
						((ExpresionContext)_localctx).exp2 = ((ExpresionContext)_localctx).expresion = expresion(11);
	...
	public final Tipo_simpleContext tipo_simple() throws RecognitionException {
		...
		try {
			...
			case T__37:
				...
				setState(315);
				match(T__37);
				 ((Tipo_simpleContext)_localctx).ast =  BooleanType.getInstance(); 
				}
				break;
			default:
				throw new NoViableAltException(this);
